      ...
      <div className="main">
        ...
        <div className="single-footer">
          ...
          <p>
            ...
            plan unforgettable custom event for every client. We bring our full
            value to every single planning, we are just an email and a phone
            call away.
          </p>
        ...
        <div class="copy">
          <p>&copy;Tolobadun Imagery 2022.</p>
        </div>
      </div>
    </footer>
  );
